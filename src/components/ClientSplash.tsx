  ...
  if (!splashDone) {
    return (
      <div className="fixed inset-0 bg-black flex flex-col items-center justify-center z-[9999]">
        <div className="text-6xl md:text-8xl font-extrabold text-blue-700 animate-pulse select-none cursor-default">
          JESÚS
          <div className="h-1 w-full bg-black mt-2 relative overflow-hidden rounded">
            <div className="absolute top-0 left-0 h-1 bg-blue-700 animate-expand" />
          </div>
        </div>
      </div>
    )
